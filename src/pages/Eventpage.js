...
const Eventpage = ({event,rules,prize,phno}) => {
  ...
  return (
    <div className='flex flex-col items-center px-5 py-32 gap-4 text-yellow-500'>
      ...
      <a href={data[event-1].link} target="__blank" className='bg-yellow-400 text-black p-2 rounded-lg hover:bg-yellow-500 border-4 border-black mb-20' data-aos="fade-up">
        click to register
      </a>
