...
const Homepage = ({setevent,home,events,contact,sponsors}) => {
  ...
  <div className="p-6 md:ml-10 md:self-center">
    ...
    <div className='flex flex-row gap-4 w-100 justify-between rounded-lg mt-20 px-5 py-3 bg-yellow-400'>
    <a href='vv' target="__blank"><img className='h-20 w-20 rounded-lg md:h-10 md:w-10' src='https://cdn-icons-png.flaticon.com/512/717/717392.png ' alt="logo"/></a>
